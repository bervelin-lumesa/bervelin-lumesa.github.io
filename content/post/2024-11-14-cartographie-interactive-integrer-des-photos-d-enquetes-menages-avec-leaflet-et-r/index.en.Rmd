...
Voila! Le résultat est une carte intéractive avec les points représantant les coordonnées de chaque ménage. En cliquant sur chaque point, nous affichons la photo de la moustique que l'enquêteur a photographié lors de la collecte de données sur terrain.
